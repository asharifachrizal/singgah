...
{{-- <link href="{{ asset('material/plugins/toast-master/css/slick.css') }}" rel="stylesheet">
<link href="{{ asset('material/plugins/toast-master/css/slick-theme.css') }}" rel="stylesheet"> --}}
{{-- <link href="{{ asset('material/plugins/toast-master/css/font-icons.css') }}" rel="stylesheet">
<link href="{{ asset('material/plugins/toast-master/css/swipper.css') }}" rel="stylesheet">
<link href="{{ asset('material/plugins/toast-master/css/style2.css') }}" rel="stylesheet"> --}}
@endsection
...
<div class="title1 section-t-space">
    <h4>Tentang Kami</h4>
    <h2 class="title-inner1">singgah art</h2>
</div>
...
<section id="team" class="team section-b-space ratio_asos">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <center><h2>Tim Kami</h2></center>
                <div class="team-4">
                    @for ($i = 0; $i < 6; $i++)
                        <div>
                            <div>
                                <img src="{{ asset('mk/images/bilhadGates.jpg') }}" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
                        ...
                        <div>
                            <div>
                                <img src="{{ asset('mk/images/misbah.jpg') }}" class="img-fluid blur-up lazyload bg-img" alt="">
                            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 service-block">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4>24 X 7 Layanan</h4>
                        <p>Layanan Online untuk Pelanggan Baru</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 service-block">
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4>Diskon Lebih dari 70%</h4>
                        <p>Dapatkan Diskon untuk Produk Kami</p>
                    </div>
                </div>
            </div>
        </div>
