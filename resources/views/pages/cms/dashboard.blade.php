                            ...
                            <div class="bg-warning card-body">
                                <div class="media static-top-widget row">
                                    ...
                                    <div class="media-body col-8"><span class="m-0">Earnings</span>
                                        <h3 class="mb-0">Rp. <span class="counter">6,659,000</span><br><small> This Month</small></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-secondary card-body">
                                <div class="media static-top-widget row">
                                    ...
                                    <div class="media-body col-8"><span class="m-0">Products</span>
                                        <h3 class="mb-0"><span class="counter">8</span><br><small> Products</small></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-primary card-body">
                                <div class="media static-top-widget row">
                                    ...
                                    <div class="media-body col-8"><span class="m-0">Orders</span>
                                        <h3 class="mb-0"><span class="counter">893</span><br><small> This Month</small></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-danger card-body">
                                <div class="media static-top-widget row">
                                    ...
                                    <div class="media-body col-8"><span class="m-0">Customer</span>
                                        <h3 class="mb-0"><span class="counter">281</span><small> Customers</small></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="user-status table-responsive latest-order-table">
                                    <table class="table table-bordernone">
                                        ...
                                        <tr>
                                            <td>1</td>
                                            <td class="digits">Rp. 120.00</td>
                                            <td class="font-danger">Bank Transfers</td>
                                            <td class="digits">On Way</td>
                                        </tr>
                                        <tr>
                                            <td>2</td>
                                            <td class="digits">Rp. 90.00</td>
                                            <td class="font-secondary">Ewallets</td>
                                            <td class="digits">Delivered</td>
                                        </tr>
                                        <tr>
                                            <td>3</td>
                                            <td class="digits">Rp. 240.00</td>
                                        ...
                                        <tr>
                                            <td>5</td>
                                            <td class="digits">Rp. 50.00</td>
                                            <td class="font-primary">Bank Transfers</td>
                                            <td class="digits">Delivered</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    <a href="{{ route('order') }}" class="btn btn-primary">View All Orders</a>
                                </div>
                                <div class="code-box-copy">
                            ...
                            <div class="card-body">
                                <div class="media">
                                    <div class="media-body">
                                        ...
                                        <h5 class="f-w-600">Gross sales of February</h5>
                    ...
                    <div class="col-xl-3 col-md-6 xl-50">
                        <div class="card order-graph sales-carousel">
                            ...
                            <div class="card-body">
                                <div class="media">
                                    <div class="media-body">
                                        <span>Monthly Registration</span>
                                        <h2 class="mb-0">21</h2>
                                        <p>0.13% <span><i class="fa fa-angle-up"></i></span></p>
                                        <h5 class="f-w-600">Avg Registration</h5>
                                        <p>Customer Registration Meningkat</p>
                                    </div>
