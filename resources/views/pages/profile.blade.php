                    ...
                    <div class="postcontent">
						...
						<form style="max-width: 50rem;">
                            ...
                            <div class="form-group">
								...
								<input type="text" class="form-control" id="full_name" name="full_name" aria-describedby="emailHelp" placeholder="Full Name">								
							</div>
							<div class="form-group">
                            ...
                            <div class="form-group">
								...
								<input type="number" class="form-control" id="phone_number" name="phone_number" aria-describedby="emailHelp" placeholder="+62">								
							</div>
