                    ...
                    <div class="postcontent">
						...
						<form style="max-width: 50rem;" action="{{ route('registerUpdate', Sentinel::getUser()->id)}}" method="POST">
							<div class="form-group">
								...
								<input type="email" class="form-control" id="email" name="email" aria-describedby="emailHelp" placeholder="Email" value="{{ Sentinel::getUser()->email }}">
                            ...
                            <div class="form-group">
								...
								<input type="text" class="form-control" id="full_name" name="full_name" aria-describedby="emailHelp" placeholder="Full Name" value="{{ Sentinel::getUser()->full_name }}">
							</div>
							<div class="form-group">
                            ...
                            <div class="form-group">
								...
								<input type="text" class="form-control" id="city" name="city" aria-describedby="emailHelp" placeholder="City" value="{{ Sentinel::getUser()->city }}">
                            </div>
                            <div class="form-group">
								<label for="exampleInputEmail1">Phone Number </label>
								<input type="number" class="form-control" id="phone_number" name="phone_number" aria-describedby="emailHelp" placeholder="+62" value="{{ Sentinel::getUser()->phone_number }}">
							</div>
