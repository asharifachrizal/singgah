    ...
    <div class="container clearfix">
        ...
        <div class="row clearfix">
            ...
            <div class="col-md-9">
                ...
                <img src="{{ asset('canvas/images/icons/avatar.jpg')}}" class="alignleft img-circle img-thumbnail notopmargin nobottommargin" alt="Avatar" style="max-width: 84px;">
                                                ...
                                                <div class="row clearfix">
                                                    <div class="col-md-4">
                                                        <div class="entry-image">
                                                            <a href="{{ asset('canvas/images/portfolio/full/17.jpg')}}" data-lightbox="image"><img class="image_fade" src="{{ asset('canvas/images/blog/grid/17.jpg')}}" alt="Standard Post with Image"></a>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-8">
                                                            ...
                                                            <div class="fslider" data-arrows="false">
                                                                <div class="flexslider">
                                                                    <div class="slider-wrap">
                                                                        <div class="slide"><img class="image_fade" src="{{ asset('canvas/images/blog/grid/10.jpg')}}" alt="Standard Post with Gallery"></div>
                                                                        <div class="slide"><img class="image_fade" src="{{ asset('canvas/images/blog/grid/20.jpg')}}" alt="Standard Post with Gallery"></div>
                                                                        <div class="slide"><img class="image_fade" src="{{ asset('canvas/images/blog/grid/21.jpg')}}" alt="Standard Post with Gallery"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="tab-content clearfix" id="tab-connections">
                                    ...
                                    <div class="row topmargin-sm">
                                        ...
                                        <div class="col-lg-3 col-md-6 bottommargin">
                                            ...
                                            <div class="team">
                                                <div class="team-image">
                                                    <img src="{{ asset('canvas/images/team/8.jpg')}}" alt="Mary Jane">
                                                </div>
                                                <div class="team-desc">
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            ...
                                            <div class="team">
                                                <div class="team-image">
                                                    <img src="{{ asset('canvas/images/team/4.jpg')}}" alt="Nix Maxwell">
                                                </div>
                                                <div class="team-desc">
