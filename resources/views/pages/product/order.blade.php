        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="form-widget">
                    ...
                    <form class="row" id="checkout-form" action="{{ route('cart.additem')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-12">
                            <div class="row checkout-form-billing">
                                ...
                                <div class="col-6 form-group">
                                    ...
                                    <input type="number" name="quantity" id="kuatiti-produk" class="form-control required" value="" placeholder="minimal 1" min="1">
                                </div>
                                <div class="col-6 form-group">
                                    <label for="ukuran-rasio-produk">Ukuran/rasio:</label><br>
                                    <input type="text" name="size" id="ukuran-rasio-produk" class="form-control required" value="" placeholder="ukuran produk">
                                </div>
                                <div class="col-12 form-group">
                                ...
                                <div class="col-12 form-group">
                                    ...
                                    <textarea class="form-control required" id="design-style-produk" name="style" rows="3" placeholder="contoh: simple, elegant, animation, etc."></textarea>
                                </div>
                                <div class="col-12 form-group">
                                    <label for="target-audience-produk">Target Audience:</label><br>
                                    <input type="text" name="target_audience" id="target-audience-produk" class="form-control required" value="" placeholder="anak-anak-dewasa / 4-6">
                                </div>
                                <div class="col-12 form-group">
