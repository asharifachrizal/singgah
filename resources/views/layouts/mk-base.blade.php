...
<head>
    ...
    <link rel="icon" href="{{ asset('mk/images/favicon/singgahFavicon.png') }}" type="image/x-icon">
...
<body>
    ...
    <!-- fly cart ui jquery-->
    <script src="{{ asset('mk/js/jquery-ui.min.js') }}"></script>

    <!-- exitintent jquery-->
    <script src="{{ asset('mk/js/jquery.exitintent.js') }}"></script>
    <script src="{{ asset('mk/js/exit.js') }}"></script>
    ...
    <!-- Fly cart js-->
    <script src="{{ asset('mk/js/fly-cart.js') }}"></script>
